    ...
    <section className="hero">
      ...
      >
        ...
        <motion.div className="hero-actions" variants={itemVariants}>
          <a href="https://investkaps.com/about" className="hero-cta-button">
            Meet Our Founder
          </a>
        </motion.div>

        <motion.div className="hero-social-join" variants={itemVariants}>
          <p className="social-join-text">Join our community</p>
          <div className="social-buttons">
            <a 
              href="https://chat.whatsapp.com/FiBsnseWfMe8Cub2Gt3r9I?mode=ems_copy_c" 
              target="_blank" 
            ...
            <a 
              href="https://t.me/join_investkaps" 
              target="_blank" 
              rel="noopener noreferrer" 
