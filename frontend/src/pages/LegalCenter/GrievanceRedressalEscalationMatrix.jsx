...
const CONTACT = {
  ...
  emailIA: 'investkaps_ia@zohomail.in',
...
/** Shared matrix body — used on standalone page and Contact Us embed. */
export const EscalationMatrixContent = ({ embedded = false }) => (
  <section
    id="grievance-redressal-escalation-matrix"
    className={embedded ? 'legal-section contact-escalation-matrix' : 'legal-section'}
  >
