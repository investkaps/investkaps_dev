  ...
  const planCards = [
    {
      ...
      details: [
        { label: 'Subscription tenor & pricing', value: ['3 months - Rs. 2,999/-', '6 months - Rs. 5,199/-'] },
    ...
    },
    {
      ...
      details: [
        ...
        { label: 'Subscription tenor', value: ['1 month - Rs. 1,999/-', '3 months - Rs. 5,499/-', '6 months - Rs. 9,999/-'] },
