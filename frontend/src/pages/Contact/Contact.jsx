        ...
        <div className="contact-container">
          ...
          <div className="primary-contact-banner">
            ...
            <div className="registration-info">
              <p><strong>SEBI RA Registration:</strong> INH000016834</p>
              <p><strong>BSE RA Enlistment:</strong> 6226</p>
              <p><strong>SEBI IA Registration:</strong> INA000022190</p>
              <p><strong>BSE IA Enlistment:</strong> 2484</p>
            </div>
            <p className="contact-tagline">
              Reach out at the details below with any queries about the services, feedback or any complaints.
            </p>
          </div>
          ...
          <div className="contact-info-grid">
            ...
            <div className="contact-info-card">
              ...
              <p className="contact-info-text">
                <span className="contact-service-label">RA Services</span>
